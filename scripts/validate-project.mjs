...
assert(pkg.version === '0.12.0', 'package.json deve usar a versão 0.12.0');
...
assert(app.includes('migrateLegacyStorage') && app.includes('BackupPanel') && app.includes('v0.12.0'), 'Engine, backup e versão devem estar conectados ao app');
...
assert(readme.includes('v0.12.0') && readme.includes('Progressão Inteligente'), 'README deve documentar a v0.12');
...
console.log('Validação do TITAN FIT v0.12.0 concluída com sucesso.');
