...
assert(evolution.includes('STATUS CORPORAL') && evolution.includes('Circunferências') && evolution.includes('Bioimpedância') && evolution.includes('Fotos') && evolution.includes('Nova avaliação completa') && evolution.includes('evolution-register-screen'), 'Centro de evolução deve funcionar como painel de status com tela própria de registro');
