...
export function ProgressPage({ refreshKey }: { refreshKey: number }) {
  ...
  return <>
    <section className="section-header evolution-center-header"><span className="eyebrow">CENTRO DE EVOLUÇÃO</span><h2>Evolução</h2><p>Acompanhe o físico e seus recordes de treino no mesmo lugar.</p></section>
