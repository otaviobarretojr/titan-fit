  ...
  return <div className="workout-mode">
    ...
    <article className={`active-exercise-card ${exerciseType === 'cardio' ? 'cardio-exercise' : ''}`}>
      ...
      {exerciseVideo && <section className={`video-stage ${videoIsRequired ? 'expanded' : 'collapsed'}`}>
        {videoIsRequired ? <>
          <div className="exercise-video"><iframe title={exerciseVideo.title} src={exerciseVideo.provider === 'vimeo' ? `https://player.vimeo.com/video/${exerciseVideo.videoId}?texttrack=pt` : `https://www.youtube-nocookie.com/embed/${exerciseVideo.videoId}?rel=0&modestbranding=1&hl=pt-BR&cc_lang_pref=pt&cc_load_policy=1`} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen /></div>
