...
describe('strength set entry', () => {
  it('asks for repetitions and weight without RIR', () => {
    const workout: TitanWorkoutDay = { id:'reps-weight-test', day:'Segunda', title:'Teste', exercises:[{ id:'bench-test', name:'Supino teste', muscleGroup:'Peito', exerciseType:'strength', sets:1, minReps:8, maxReps:12, restSeconds:60 }] };
