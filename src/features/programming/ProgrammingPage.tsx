...
type ProgrammingTab = 'strength' | 'cardio';
...
export function ProgrammingPage({ plan }: Props) {
  ...
  return <div className="programming-page">
    <section className="section-header programming-header"><span className="eyebrow">PLANEJAMENTO SEMANAL</span><h2>Programação</h2><p>Consulte sua semana sem misturar musculação e cardio.</p></section>
