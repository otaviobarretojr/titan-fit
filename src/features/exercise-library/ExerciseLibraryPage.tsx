...
export function ExerciseLibraryPage() {
  ...
  return <section className="exercise-library-page" aria-label="Biblioteca TITAN de exercícios">
    <div className="library-hero"><div><span className="eyebrow">BIBLIOTECA TITAN</span><h3>Exercícios</h3><p>{TITAN_FULL_EXERCISE_CATALOG.length} exercícios estruturados para consulta e prescrição.</p><small className="library-video-coverage">Vídeos demonstrativos: {coverage.covered}/{coverage.total} · {coverage.percentage}% cobertos</small></div><span className="library-count">{results.length}</span></div>
