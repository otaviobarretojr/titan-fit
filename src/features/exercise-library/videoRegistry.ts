...
export const EXERCISE_VIDEO_REGISTRY: Record<string, ExerciseVideoMetadata> = {
  ...
  'bench-press': embedded('bench-press','gCq7ew9bPds','Supino reto com barra — execução','FITTR'),
  'cable-chest-press': embedded('cable-chest-press','c2qg58fPSlE','Supino no cabo — execução','FITTR'),
  ...
  'dumbbell-shoulder-press': embedded('dumbbell-shoulder-press','fjQdQNjqS1A','Desenvolvimento com halteres — execução','FITTR'),
  ...
  'barbell-squat': embedded('barbell-squat','GbUShgjRdkU','Agachamento com barra — execução','FITTR'),
  ...
  'romanian-deadlift': embedded('romanian-deadlift','1KQqdFBv1dk','Levantamento romeno — execução','FITTR'),
  'conventional-deadlift': embedded('conventional-deadlift','r4MzxtBKyNE','Levantamento terra — execução','FITTR'),
  ...
  'plank': embedded('plank','6VmeHbHGlxY','Prancha — execução','FITTR'),
